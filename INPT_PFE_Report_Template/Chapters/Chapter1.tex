...
% TODO(screenshot): Replace placeholder with actual Gantt chart image
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}\textbf{[PLACEHOLDER --- Gantt chart]}\\Capture or export the project Gantt chart showing Tasks~1--6 across\\February--September 2026.\vspace{3cm}}}
